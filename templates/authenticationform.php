...
<form method="POST" target="<?= $target ?>">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="password" class="form-control" id="auth-password1" name="password1" aria-describedby="password1-help"  required>
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="password" class="form-control" id="auth-password2" name="password2" aria-describedby="password2-help"  required>
			<small id="password1-help" class="form-text text-muted">
